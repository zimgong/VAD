...
class VADtl(MVXTwoStageDetector):
    """VAD model.
    """
    ...
    def forward_pts_train(self,
        ...
        outs = self.pts_bbox_head(pts_feats, img_metas, prev_bev,
                                  ego_his_trajs=ego_his_trajs, ego_lcf_feat=ego_lcf_feat, cf_img=cf_img)
        loss_inputs = [
            gt_bboxes_3d, gt_labels_3d, map_gt_bboxes_3d, map_gt_labels_3d,
            outs, ego_fut_trajs, ego_fut_masks, ego_fut_cmd, gt_attr_labels, traffic_signal
        ]
    ...
    def forward_train(self,
        ...
        losses_pts = self.forward_pts_train(img_feats, gt_bboxes_3d, gt_labels_3d,
                                            ...
                                            ego_lcf_feat=ego_lcf_feat, cf_img=cf_img,
                                            traffic_signal=traffic_signal, gt_attr_labels=gt_attr_labels)
