...
from mmcv.models.builder import build_backbone
...
class VADTLHead(DETRHead):
    ...
    def __init__(self,
        ...
        if map_class_weight is not None and (self.__class__ is VADTLHead):
        ...
        super(VADTLHead, self).__init__(*args, transformer=transformer, **kwargs)
    ...
    def _init_layers(self):
        ...
        # CHANGE
        ego_fut_dec_in_dim = ego_fut_dec_in_dim + self.embed_dims
