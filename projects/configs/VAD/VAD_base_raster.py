...
col_class = [
    ...
    "construction_vehicle",
    "bus",
]  # collision classes, result in loss term
...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        # TODO: use pretrain model // add color normalization
        raster_net=dict(
            type="VQVAE2D",
            ...
            encoder=dict(
                ...
                norm_eval=True,
                style="pytorch",
                init_cfg=dict(type="Pretrained", checkpoint="ckpts/resnet34-333f7ec4.pth"),
            ),
            quantizer=dict(
        ...
        loss_plan_col=dict(
            ...
            x_dis_thresh=3.0,
            y_dis_thresh=1.5,
            agent_thresh=0.5,  # for nuplan coord
...
load_from = "/data/ceph/data/nuplan/VAD_model_5cmd.pth"
